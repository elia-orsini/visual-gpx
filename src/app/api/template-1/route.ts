...
import { handDrawnText } from "@/utils/templates/hand-drawn/handDrawnText";
import { drawGpxShape } from "@/utils/templates/hand-drawn/drawGpxShape";
...
export async function POST(request: Request) {
  try {
    ...
    const dateFormatted = formatDate(startDate).toUpperCase();
    ...
    drawGpxShape(image, points);

    const buffer = await handDrawnText({
      image,
